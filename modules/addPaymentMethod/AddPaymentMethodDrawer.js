...
import AddPaymentMethod from 'modules/addPaymentMethod';
...
class HeaderOptions extends Component {
  ...
  back = () => {
    this.props.navigationProps.push('drawerStack');
  };
  render() {
    return (
...
const AddPaymentMethodStack = createStackNavigator({
